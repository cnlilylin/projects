...
public class TestUtils {
 ...
 public static Record createRecordOfBool() {
 ...
 public static Record createRecordOfTwoInts() {
     List<DataType> dataValues = new ArrayList<DataType>();
     dataValues.add(new IntDataType(5));
     dataValues.add(new IntDataType(10));

     return new Record(dataValues);
   }
 
 public static Record createRecordOfString() {
     List<DataType> dataValues = new ArrayList<DataType>();
     dataValues.add(new StringDataType("hello", 5));
